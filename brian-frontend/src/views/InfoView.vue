...
import { useHistoryTab } from '../composables/useHistoryTab'
import { useMemoryTab } from '../composables/useMemoryTab'
import { useLibraryTab } from '../composables/useLibraryTab'
