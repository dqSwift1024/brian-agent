...
| 方法 | 签名 | 返回 | 说明 |
|------|------|------|------|
| `registerStream` | `input: RegisterStreamInput, output: RegisterStreamOutput, _context: StreamContext, metr...` | `Promise<boolean>` | — |
| `pushStream` | `input: PushStreamInput<T>, _context: StreamContext, output: PushStreamOutput` | `Promise<boolean>` | — |
| `closeStream` | `input: CloseStreamInput, output: CloseStreamOutput, _context: StreamContext, metrics?: ...` | `Promise<boolean>` | — |
| `soStreamStats` | `_context: StreamContext, output: GetStreamStatsOutput` | `Promise<boolean>` | — |
| `configStream` | `input: ConfigStreamInput, output: ConfigStreamOutput, _context: StreamContext, metrics?...` | `Promise<boolean>` | — |
